...
# ========================
# CARGA DE ARCHIVO DE PRECIOS DESDE LA APP
# ========================
st.sidebar.markdown("---")
st.sidebar.markdown("📤 **Actualizar archivo de precios**")
archivo_excel = st.sidebar.file_uploader("Subir archivo Excel (.xlsx)", type=["xlsx"])
if archivo_excel is not None:
    with open("/mnt/data/precios_threatdown.xlsx", "wb") as f:
        f.write(archivo_excel.read())
    st.sidebar.success("Archivo de precios actualizado correctamente.")
